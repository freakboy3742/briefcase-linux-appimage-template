...
**This is the development version of the repository. It contains a template for manylinux2014**.
Other manylinux versions are available by cloning other branches of repository.
...
2. Run ``cookiecutter`` on the template::
    ...
    $ cookiecutter https://github.com/beeware/briefcase-linux-appimage-template --checkout manylinux2014
...
3. `Download a Python Linux support package for manylinux2014_x86_64`_, and extract it into
...
.. _Download a Python Linux support package for manylinux2014_x86_64: https://briefcase-support.org/python?platform=linux&manylinux=2014&arch=x86_64&version=3.10
